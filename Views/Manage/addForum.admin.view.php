...
<div class="d-flex flex-wrap justify-content-between">
    <h3><i class="fa-solid fa-book"></i> <span
            class="m-lg-auto"><?=LangManager::translate("forum.manage.addForum.addForum")?> <?= $category->getName() ?></span></h3>
</div>
    ...
    <div class="col-12 col-lg-6 mx-auto">
        <form class="card" method="post">
            <div class="card-body">
                ...
                <h6><?=LangManager::translate("forum.manage.addForum.name")?><span style="color: red">*</span> :</h6>
                ...
                <div class="form-group position-relative has-icon-left">
                    ...
                    <small class="form-text"><?=LangManager::translate("forum.manage.addForum.icon")?><a href="https://fontawesome.com/search?o=r&m=free"
                                   target="_blank">FontAwesome.com</a></small>
                </div>
                <h6><?=LangManager::translate("forum.manage.addForum.desc")?></h6>
                <div class="form-group position-relative has-icon-left">
                ...
                <div class="form-check form-switch mt-4">
                    ...
                    <label class="form-check-label" for="disallowTopics"><h6><?=LangManager::translate("forum.manage.addForum.noNewTopics")?></h6></label>
                </div>
                <div class="form-check form-switch mt-4">
                    <input class="form-check-input allowedGroups" type="checkbox" id="allowedGroupsToggle" name="allowedGroupsToggle">
                    <label class="form-check-label" for="allowedGroupsToggle"><h6><?=LangManager::translate("forum.manage.addForum.noAcess")?></h6></label>
                </div>
                <div class="mt-2" id="listAllowedGroups">
                    <h6><?=LangManager::translate("forum.manage.addForum.role")?></h6>
