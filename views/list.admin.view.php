                ...
                <?php foreach ($categoryModel->getCategories() as $category):?>
                    <div class="card-in-card table-responsive mb-4">
                        <table class="table-borderless table table-hover mt-1">
                            <thead>
                                <tr>
                                    <th id="categorie-<?= $category->getId() ?>"> <?= $category->getName() ?> -<i><small><?= mb_strimwidth($category->getDescription(), 0, 45, '...') ?></small></i></th>
                                    <th class="text-end">
                            ...
                            <tbody>
                                ...
                                <tr id="forum-<?= $forumObj->getId() ?>">
                                    <td class="ps-4 text-bold-500"><?= $forumObj->getName() ?>
                                    </td>
                                    <td class="text-end">
