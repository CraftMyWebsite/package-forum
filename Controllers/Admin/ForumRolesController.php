...
class ForumRolesController extends AbstractController
{
    ...
    #[NoReturn]
    #[Link('/roles/delete/:roleId', Link::GET, [], '/cmw-admin/forum')]
    ...
    #[NoReturn]
    #[Link('/roles/add', Link::POST, [], '/cmw-admin/forum')]
    ...
    #[NoReturn]
    #[Link('/roles/edit/:role_id', Link::POST, [], '/cmw-admin/forum')]
    ...
    #[NoReturn]
    private function forumRolesSetDefault(int $id, string $question): void
    {
        UsersController::redirectIfNotHavePermissions('core.dashboard', 'forum.roles');
    ...
    #[NoReturn]
    #[Link('/roles/block/:userId', Link::POST, ['userId' => '[0-9]+'], '/cmw-admin/forum')]
    ...
    #[NoReturn]
    #[Link('/roles/unblock/:userId', Link::POST, ['userId' => '[0-9]+'], '/cmw-admin/forum')]
